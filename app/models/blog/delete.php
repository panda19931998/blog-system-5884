...
$sql = "select * from blog_category_master where blog_category_code = :blog_category_code and client_id = :client_id blog_id =:blog_id limit 1";
...
$sql = "delete from blog_category_master where client_id =:client_id and blog_id =:blog_id and blog_category_code = :blog_category_code";
$stmt = $pdo->prepare($sql);
