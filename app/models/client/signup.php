				...
				<div class="register-content"  >
					...
					<div class="form-group <?php if ($err['client_name'] != '') echo 'has-error'; ?>">
						...
						<div class="row row-space-10">
							<div class="col-md-12" >
								<input type="text" name="client_name" class="form-control" value="<?php if(isset($err['client_name']))echo h($client_name); ?>" placeholder="" required />
					...
					<div class="form-group <?php if ($err['secret_code'] != '') echo 'has-error'; ?>">
						...
						<div class="row m-b-15">
							<div class="col-md-12 ">
								<input type="text" class="form-control" name="secret_code" value="<?php if(isset($err['secret_coe'])) echo h($secret_code); ?>" placeholder="招待コードをお持ちの方のみがご登録いただけます。" required />
